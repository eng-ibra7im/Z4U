<template>
    <main class="overflow-hidden">
            ...
            <div class="row pb-0 mt-5 gap-lg-3">
                <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                    <h1 class="text-black fw-bolder lh-base display-5 mb-1 text-center text-md-start">
                        برنامج إدارة علاقات العملاء <br> CRM
                    </h1>
                    <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                        أدر عملائك باحترافية من خلال مجموعة تطبيقات متكاملة ذات واجهة سهلة الاستخدام، تدعم اللغة العربية
                        من أي مكان وفي أي وقت. وتلبي كافة احتياجات إدارة العملاء دون الحاجة لاستخدام عدة برامج CRM
                        والربط بينهم للحصول على النتائج المرادة.
                    </p>
                    <ul
                        ...
                        <li class="my-1">
                            يمكنك استخدام برنامج حفظ بيانات العملاء مجانًا لمدة 14 يوم.
                        </li>
                        <li class="my-1">
                            إنشاء سجل كامل لكل عميل لديك على حدة متضمنًا كافة بياناته ومعلومات التواصل الخاصة به وكذلك
                            مدفوعاته ومشروعاته وسجل نشاطاتها.
                        </li>
                        <li class="my-1">
                            تنظيم حجوزاتك ومواعيد المقابلات مع عملائك وتعيين الموظفين المتخصصين لإدارتهم بسلاسة
                        </li>
                        <li class="my-1">
                            إدارة الاشتراكات والعضويات ومجموعة الباقات الخاصة بكل منهم وتعرف على الرصيد المستهلك
                            والمتبقي منها.
                        </li>
                        <li class="my-1">
                            متابعة الأقساط وعمليات الدفع وإرسال تنبيهات بالمستحق منها من خلال الأدوات المتقدمة وخصائص
                            الأتمتة في النظام.
                        </li>
                        <li class="my-1">
                            استعراض كشوفات الحساب والتقارير التفصيلية لضمان رضا عملائك عن منتجاتك وخدماتك المقدمة لهم.
                        </li>
                    </ul>
                </div>
        ...
        <div class="bg-settings">
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                أنشئ سجلًا لكل عميل باستخدام برنامج <br> تسجيل بيانات العملاء
                            </h2>
                            <p class="text-black-50 fs-5 lh-base fw-bold mt-4 text-center text-md-start">
                                أنشئ ملفًا تعريفيًا لكل عميل على حدة متضمنًا بياناته ومعلومات التواصل لبناء قاعدة بيانات
                                للعملاء، واستخدم الحقول المخصصة لتصميم ملفاتهم التعريفية بما يتناسب مع احتياجات أعمالك،
                                وأضف المرفقات والملاحظات اللازمة وشاركها مع عميلك سواء عبر البريد الإلكتروني أو على
                                حسابه الخاص في نظامك، وحدد السجل التجاري والرقم الضريبي والأرصدة الافتتاحية وبيانات
                                الدفع، وأضف الحالات اليدوية في ملف العميل لمتابعته بدقة، وذلك بغرض تسهيل الإجراءات
                                المطلوب اتخاذها لضمان رضا العميل.
                            </p>
                        </div>
                        <div
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/create-sc.png" alt="moon"
            ...
            <section class="container">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                فعّل برنامج متابعة العملاء وكن على <br> تواصل دائم مع عملائك
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                استخدم القوالب الجاهزة القابلة للتخصيص في نظام دفترة لإرسال رسائل نصية قصيرة أو رسائل
                                بريد إلكتروني لعملائك، أرسل الفواتير وعروض الأسعار كشوفات الحساب في رسائل مخصصة تعكس
                                هوية علامتك التجارية المميزة، وأرسل تذكيرات بالحجوزات والمواعيد وعمليات التسليم والأقساط
                                المستحقة، وكذلك أفضل العروض وآخر التحديثات الخاصة بأعمالك من خلال قواعد الإرسال الآلي في
                                النظام.
                            </p>
                        </div>
                        <div class="circles">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/schedule-sccc.png" alt="moon"
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                وفِّر صلاحية وصول لعملائك إلى <br> حساباتهم على النظام
                            </h2>
                            <p class="text-black-50 fs-5 lh-base fw-bold mt-4 text-center text-md-start">
                                تواصل مع عميلك بفعالية من خلال التجربة المرنة التي يتيحها لك نظام دفترة، حيث يمكنك منح
                                العميل صلاحية تسجيل حساب له عبر الإنترنت إلى جانب صلاحيات للحساب الذي قمت بإنشائه له في
                                النظام، فيمكنك تمكين العميل عرض ملفه الشخصي بما في ذلك كافة بياناته الشخصية والتعديل
                                عليها، مع إمكانية مشاهدة الملحوظات والمرفقات المشتركة، والفواتير المستحقة عليه ودفعها
                                عبر الإنترنت وكذلك عروض الأسعار والموافقة عليها، كما يمكنك منحه صلاحية عرض المواعيد
                                والحجوزات وإجراء عمليات الحجز أونلاين، وذلك للحصول على تجربة أكثر تفاعلية مع عميلك
                                لتسهيل الإجراءات اللازمة وتوفير الوقت والجهد.
                            </p>
                        </div>
                        <div class="circles2">
                            <img src="../assets/images/circles-r.webp" alt="circles" class="img-fluid">
        ...
        <div class="bg-settings mtt">
            <section class="container mt-5">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                نظم حجوزات عملائك باحترافية
                            </h2>
                            <p class="text-black-50 fs-5 lh-base fw-bold mt-4 text-center text-md-start">
                                أدِر عمليات الحجز لكل عميل لديك بكفاءة واحترافية مع الأدوات والخصائص المتقدمة في النظام،
                                حيث يمكنك تلقي عمليات الحجز مباشرة من عملائك عبر الإنترنت، أو إجراء الحجوزات من داخل
                                حسابك بما يتوافق مع وردية عمل موظفيك، مع ضمان عدم تداخل عمليات الحجز بين باقي العملاء في
                                تطبيق الحجوزات، وأرسل تذكيرات بالمواعيد إلى عملائك وموظفيك من خلال الرسائل النصية
                                القصيرة، وأتِح لهم إمكانية الدفع الإلكتروني للحجوزات والمواعيد قبل الحضور، وابقَ على
                                تواصل دائم معهم للوصول إلى مستوى رضا العملاء المطلوب لتحقيق أهداف أعمالك.
                            </p>
                        </div>
                        <div class="circles">
                            <img src="../assets/images/circles.png" alt="circles" class="img-fluid">
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5  position-relative">
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/assign-sc2.png" alt="moon"
                            class="img-fluid  mt-3 justify-content-center rounded-5 animate__animated animate__slideInRight animate__slower 2s"
                            title="moon" />
                    </div>
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-3 text-center text-md-start">
                                أدِر العضويات والاشتراكات لعملائك <br> بكفاءة
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-3 text-center text-md-start">
                                وفِّر نظام العضويات المخصصة والاشتراكات لعملائك وأدِرها بفعالية حسب مجال عملك وآلية
                                العمل داخل شركتك، وصمم باقات خدمات تناسب عملائك وحدد النقاط والأرصدة في كل باقة منها
                                وتابع استهلاك العميل لها والحصص أو الأيام المتبقية منها، وكذلك تابع حضور العملاء بدقة،
                                كما يمكنك استخدام رسائل التنبيه للتذكير بمواعيد تجديد اشتراكاتهم والعضويات المنتهية، إلى
                                جانب البقاء على اطلاع بأكثر الباقات استخدامًا من عملائك.
                            </p>
                        </div>
                        <div class="circles2">
                            <img src="../assets/images/circles-r.webp" alt="circles" class="img-fluid">
            ...
            <section class="container mt-5">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                أضف أوامر الشغل لمشروعات عميلك
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                أنشئ سجلًا خاصًا بأوامر الشغل للمشروعات الخاصة بكل عميل لديك بحيث يتضمن كل إجراءات تنفيذ
                                المشروع والمصروفات وسجل الإيرادات والفواتير ذات الصلة، وتابع بكفاءة كل الإجراءات
                                والخطوات التي يتم اتخاذها بشأن المشروع من خلال سجل نشاط خاص بكل أمر عمل لديك في شركتك.
                            </p>
                        </div>
                        <div class="circles">
                            <img src="../assets/images/circles.png" alt="circles" class="img-fluid">
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5  position-relative">
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-3 text-center text-md-start">
                                أدِر أقساط عملائك ومدفوعاتهم بفعالية
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-3 text-center text-md-start">
                                قسِّم الفواتير المستحقة على عملائك إلى أقساط بخطوات بسيطة، استخدم الأدوات المتقدمة في
                                نظام دفترة لتقسيم المدفوعات المستحقة على عملائك حسب اتفاقية التقسيط بينك وبينهم، وتابع
                                تسديدها أولًا بأول، وأرسل إشعارات تنبيه بالأقساط التي حان موعد سدادها، ووفِّر لعملائك
                                خيارات دفع سواء دفع إلكتروني عبر الإنترنت أو غيرها من خيارات الدفع التي يدعمها النظام،
                                وتابع عملية تحصيل الفواتير المستحقة من خلال الواجهة سهلة الاستخدام بأدوات متقدمة مع نظام
                                دفترة المتكامل.
                            </p>
                        </div>
                        <div class="circles2">
        ...
        <section class="container mtt">
            <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                    <div>
                        <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                            تابع عملاءك بفعالية عبر تقارير مفصلة
                        </h2>
                        <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                            يتيح لك برنامج إدارة العملاء إمكانية إصدار التقارير التفصيلية عن كل جوانب أعمالك للحصول على
                            رؤية أوضح حول مدى رضاهم عن منتجاتك وخدماتك المقدمة لهم، بما في ذلك تقارير أعمار الديون ودليل
                            العملاء وأرصدتهم ومبيعاتهم ومدفوعاتهم، إلى جانب تقارير كشف حساب العملاء ومواعيدهم وأقساطهم،
                            وكذلك تقارير الاشتراكات الجديدة والعضويات المنتهية وتجديدها.
                        </p>
                    </div>
                    <div class="circles">
                        <img src="../assets/images/circles.png" alt="circles" class="img-fluid">
