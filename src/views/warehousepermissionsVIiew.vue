    ...
    <main class="overflow-hidden">
            ...
            <div class="row pb-0 gap-lg-3">
                <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                    <h1 class="text-black fw-bolder lh-base display-5 text-center text-md-start">
                        برنامج إدارة الأذون المخزنية
                    </h1>
                    <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">نظِّم أذونك المخزنية
                        بكفاءة مع Z4U في واجهة سهلة الاستخدام تدعم اللغة العربية، حيث يمكنك إنشاء أذون الإضافة والصرف
                        والتحويل بين المستودعات لتتبع حركات المنتجات في المخزون، ابق على اطلاع دائم بمستويات المخزون
                        لديك وحركات المنتجات به وأنشطة أمناء المخازن لديك من خلال تقارير الجرد والمخزون المختلفة.
                    </p>
                    <div
                ...
                <div class="col-lg-5 col-md-6">
                    <img src="../assets/images/page-banner23.webp" alt="moon"
        ...
        <div class="bg-settings">
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                أدِر أذون الإضافة والصرف آليًا
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                عند إصدار فواتير البيع للعملاء أو فواتير الشراء من الموردين، سيقوم النظام بأتمتة إصدار
                                الأذون المخزنية بالإضافة للكميات المستلمة من المورين عند الشراء وكذا الأذون المخزنية
                                بالصرف للكميات الصادرة عند البيع.
                            </p>
                        </div>
                        <div
                            class="d-flex align-items-center gap-2 justify-content-center justify-content-lg-start w-auto me-auto">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/outbound-requisitions.webp" alt="moon"
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/quick-copy.webp" alt="moon"
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                استخدم خاصية النسخ واللصق لفعالية أكبر
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                أصدر الأذون المخزنية المنشأة يدويًا بسرعة من خلال نسخ كافة البيانات المطلوبة المضمنة في
                                أي ملفات Excel خارجية ولصقها في شاشة إدخال الإذن المخزني على النظام بدلًا من إجراء
                                التحديدات اليدوية لكل منتج بمفرده أو إدخال باقي البيانات في كل حقل على حدة.
                            </p>
                        </div>
                        <div class="circles2">
        ...
        <div class="bg-settings mtt mb-5">
            <section class="container">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mtt mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                نظِّم عمليات التحويل بين المستودعات بكفاءة
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                احصل على تجربة مرنة بالكامل عند تحويل منتجاتك من مستودع إلى آخر تلبية لمتطلبات الفروع
                                الأخرى أو لسد النقص في أحد مستودعاتك عبر أدوات متقدمة سهلة الاستخدام في نظام Z4U لدقة
                                أكبر في تتبع حركة منتجاتك.
                            </p>
                        </div>
                        <div class="circles">
                            <img src="../assets/images/circles.png" alt="circles" class="img-fluid">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/manually-transfere333.webp" alt="moon"
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/assign-employees.webp" alt="moon"
                            class="img-fluid   justify-content-center rounded-5 animate__animated animate__slideInRight animate__slower 2s"
                            title="moon" />
                    </div>
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                عيِّن صلاحيات محددة لأمناء المخازن
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                يتيح لك Z4U تعيين الأدوار إلى موظفيك من أمناء المخازن لديك بما في ذلك معالجة الأذون
                                المخزنية المختلفة سواء الموافقة عليها أو رفضها حسب المستوى الوظيفي لكل منهم، مع إمكانية
                                مراقبة نشاطاتهم والتعرف على مستويات الأداء لكل منهم.
                            </p>
                        </div>
                        <div class="circles2">
                            <img src="../assets/images/circles-r.webp" alt="circles" class="img-fluid">
        ...
        <section class="container">
            <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                <div class="col-lg-6 col-md-6 mt-0 mtt mb-5 mb-md-0 order-1 order-md-0">
                    <div>
                        <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                            راقب مخزونك بتقارير مفصلة
                        </h2>
                        <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                            أًصدر التقارير المفصلة لتتبع مخزونك ومراقبة كمية المنتجات به حسب نوع الأذن المخزني سواء
                            بالإضافة أو الصرف أو التحويل للحصول على رؤية أوضح حول مجريات أعمالك لاتخاذ القرارات اللازمة
                            لضمان رضا عملائك.
                        </p>
                    </div>
                    <div class="circles">
                ...
                <div class="col-lg-5 col-md-6">
                    <img src="../assets/images/track-stock.webp" alt="moon"
                        class="img-fluid mt-5  justify-content-center rounded-5 animate__animated animate__slideInLeft animate__slower 2s"
                        title="moon" />
                </div>
            </div>
