    ...
    <main class="overflow-hidden">
            ...
            <div class="row pb-0  gap-lg-3">
                <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                    <h1 class="text-black fw-bolder lh-base  mb-2 text-center text-md-start">
                        برنامج الفاتورة الإلكترونية المصرية
                    </h1>
                    <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                        يعد برنامج الفاتورة الإلكترونية المصرية من Z4U نظاماً محاسبيًا متكاملًا لإدارة الأعمال، وجاهز
                        للعمل وفق آليات الربط والتكامل مع منظومة الفاتورة الإلكترونية حسب متطلبات مصلحة الضرائب المصرية،
                        حيث يمكنك إصدار الفواتير الإلكترونية متضمنة لكافة المعايير المطلوبة من بيانات البائع والمشتري
                        وتكويد للأصناف، إلى جانب إمكانية تخصيصه حسب مجال عملك، حيث يتيح لك إدارة مبيعاتك وحساباتك
                        ومخازنك وعملائك وموظفيك وغيرها من متطلبات الأعمال، وذلك في أي وقت وأي مكان ومن أي جهاز لكونه
                        حلًا برمجيًا يستند إلى السحابة، مما يوفر السلاسة المطلوبة لسير عمل أفضل لرفع مستوى إدارة
                        الأعمال.
                    </p>
                    <ul
                ...
                <div class="col-lg-5 col-md-6">
                    <img src="../assets/images/home-customize.webp" alt="moon"
        ...
        <div class="bg-settings">
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                اربط حسابك مع برنامج الفاتورة الإلكترونية <br> المصرية في خطوات بسيطة
                            </h2>
                            <p class="text-black-50 fs-5 lh-base fw-bold mt-4 text-center text-md-start">
                                مع Z4U يمكنك إصدار الفواتير الإلكترونية في مصر بالمتطلبات اللازمة التي حددتها مصلحة
                                الضرائب المصرية لمنظومة الفاتورة الإلكترونية بسهولة وفي خطوات بسيطة لمستخدم برنامج
                                الفاتورة الالكترونية المصرية، حيث تتضمن الفاتورة المصدرة من خلال Z4U كافة الحقول
                                المطلوبة من توصيف دقيق للسلع أو الخدمات التي تقدمها إلى عملائك، إلى جانب تضمين الضرائب
                                المطبقة مثل ضريبة القيمة المضافة على أن يتم احتسابها آليًا داخل الفاتورة المُصدرة.
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/60e99c976eed7_blobid1625922709626.png" alt="moon"
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                أضِف الكود الموحد للسلع والخدمات مع برنامج <br> الفاتورة الالكترونية من Z4U
                            </h2>
                            <p class="text-black-50 fs-5 lh-base fw-bold mt-4 text-center text-md-start">
                                عند إنشاء فاتورة إلكترونية وإرسالها إلى المنظومة، ألزمت مصلحة الضرائب المصرية كل ممول
                                بتضمين كود موحد للسلع التي يوفرها للعميل في فاتورته المُصَدرة، لذا وفَّر Z4U إمكانية
                                تعيين الكود الموحد للسلعة أو الخدمة في خطوات بسيطةمع إمكانية الاستعانة بميزة الاستيراد
                                لتعيينها بشكل سريع إلى قائمة الأصناف لدى شركتك واستدعائها مباشرة بعد ذلك في الفواتير
                                المصدرة وإرسالها تالياً إلى حسابك لدى مصلحة الضرائب. ولقد قمنا بعمل أداة لاستخراج اكواد
                                GS1 بالعربي لتسهيل استخراج الاكواد العالمية والمصرية
                            </p>
                        </div>
                        <div class="circles2">
            ...
            <section class="container">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                أضِف الختم الإلكتروني في فواتيرك المُصدَّرة
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                يمكنك من خلال برنامج الفاتورة الالكترونية من Z4U تعيين الختم الإلكتروني الذي ألزمت به
                                مصلحة الضرائب كل الممولين لضمان صحة بيانات الفاتورة التي يتم إصدارها. فبعد الحصول على
                                شهادة التوقيع الإلكتروني من خلال شركة إيجيبت تراست المسؤولة عن إصدار شهادات الختم
                                الإلكتروني للمنظومة؛ ستتمكن من تضمين الختم داخل الفاتورة عند إرسالها إلى حسابك لدى مصلحة
                                الضرائب.
                            </p>
                        </div>
                        <div class="circles">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/catering-accounting.jpeg" alt="moon"
