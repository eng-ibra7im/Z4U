            ...
            <div class="row pb-0 gap-lg-3">
                <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                    <h1 class="text-black fw-bolder lh-base display-5 mb-1 text-center text-md-start">
                        برنامج الاشتراكات <br> والعضويات الشهرية
                    </h1>
                    <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                        يتيح لك نظام Z4U عبر تطبيق الاشتراكات والعضويات إمكانية فتح باب تسجيل العضويات للعملاء وإضافة
                        الاشتراكات وتحديد مدتها وربطها مع مجموعة من المزايا الإضافية في صورة حصص أو نقاط بنظام
                        الاستهلاك؛ أصدر الفواتير الدورية عن كل اشتراك وتابع حالات التجديد والاشتراكات أو العضويات
                        المنتهية عبر التقارير التفصيلية في واجهة سهلة الاستخدام تدعم اللغة العربية.
                    </p>
                    <ul
                        ...
                        <li class="my-1">
                            تعريف الباقات والاشتراكات الشهرية مع تحديد مدتها وسعرها.
                        </li>
                        <li class="my-1">
                            ضبط أرصدة العميل وتتبع المستهلك والمتبقي منها.
                        </li>
                        <li class="my-1">
                            إصدار فواتير دورية عن الاشتراكات.
                        </li>
                        <li class="my-1">
                            تفعيل وتجديد الاشتراكات آليًا.
                        </li>
                        <li class="my-1">
                            إصدار تقارير الاشتراكات.
                        </li>
                    </ul>
                </div>
                <div class="col-lg-5 col-md-6">
                    <img src="../assets/images/page-banner20.svg" alt="moon"
                ...
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            ...
                            <p class="text-black-50 fs-5 lh-base fw-bold mt-4 text-center text-md-start">
                                بما أن تطبيقات نظام Z4U متكاملة فيما بينها، فإن تطبيق العضويات والاشتراكات يعمل جنبًا
                                ...
                                الاشتراكات والعضويات نفسه. إذ يعمل نظام Z4U على الربط بين النظامين ربطًا كاملًا.
                            </p>
                        </div>
                        <div class="circles2">
                            <img src="../assets/images/circles-r.webp" alt="circles" class="img-fluid">
