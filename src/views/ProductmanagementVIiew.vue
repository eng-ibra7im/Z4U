    ...
    <main class="overflow-hidden">
            ...
            <div class="row pb-0 gap-lg-3">
                <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                    ...
                    <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                        نظِّم دورة حياة المنتجات بالكامل من خلال إدارة المخزون في نظام Z4U السحابي عبر واجهة سهلة
                        الاستخدام بدعم كامل للغة العربية، احتفظ بقاعدة بيانات منتجاتك في ملف تعريفي متكامل يتضمن كافة
                        بيانات المنتج أو الخدمة التي تقدمها لعملائك، ابحث عن المنتجات بالباركود وتتبعها بطرق متعددة بما
                        في ذلك الرقم التسلسلي أو رقم الشحنة أو تاريخ الانتهاء، وأضف المنتجات المجمعة ونظمها باحترافية
                        وضمنها في فواتيرك بسهولة، مع إمكانية تتبع طلبات المنتجات ومراقبة كمياتها وحركاتها من خلال تقارير
                        الجرد والمخزون المفصلة.
                    </p>
                    <div
                ...
                <div class="col-lg-5 col-md-6">
                    <img src="../assets/images/page-banner32.webp" alt="moon"
        ...
        <div class="bg-settings">
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                أضف منتجاتك في حسابك متضمنة كافة التفاصيل اللازمة
                            </h2>
                            <p class="text-black-50 fs-5 lh-base fw-bold mt-4 text-center text-md-start">
                                بفضل الأدوات المتقدمة في Z4U، يمكنك إضافة قائمة بمنتجاتك متضمنة كل البيانات المطلوبة
                                بما في ذلك أكواد التخزين والباركود والأسعار، كما يمكنك تنظيم مستودعك على نحو أفضل من
                                خلال تصنيف العناصر وعلاماتها التجارية، مع تحديد تفاصيل التسعير لكل منتج بما في ذلك أسعار
                                الشراء والبيع وأقل سعر بيع، إلى جانب الخصومات المطبقة، وإمكانية إضافة المنتج إلى قائمة
                                أسعار مخصصة، بالإضافة إلى إعدادات المخزون التي تحدد كمية المنتج في المستودع وطريقة
                                التتبع المطلوبة.
                            </p>
                        </div>
                        <div
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/products-details.webp" alt="moon"
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/bundle-products21.webp" alt="moon"
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                أنشئ منتجاتك المجمعة بسهولة
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                يتيح لك Z4U إمكانية إنشاء المنتجات المجمعة وفقًا لمتطلبات أعمالك بأدوات متقدمة سهلة
                                الاستخدام لتنظيمها تنظيمًا احترافيًا، سواء إنشائها وتسجيلها في مخزونك، أو تضمينها عند
                                إصدار الفاتورة على الفور، حيث يخصم النظام تلقائيًا من كمية الأصناف التي يتكون منها
                                المنتج المجمع.
                            </p>
                        </div>
                        <div class="circles2">
        ...
        <div class="bg-settings mtt mb-5">
            <section class="container">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                خصِّص وحدات قياسك حسب أعمالك
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                أنشئ قوالب وحدات قياس متعددة لمنتجاتك بأنواعها المختلفة سواء الأساسية أو مشتقاها، وحدد
                                وحدة القياس الأساسية لكل منتج ووحدة الشراء والبيع والمخزون المتاح، إلى جانب تحديد
                                التمييز للمنتج أثناء إصدار فاتورة البيع أو الشراء.
                            </p>
                        </div>
                        <div class="circles">
                            <img src="../assets/images/circles.png" alt="circles" class="img-fluid">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/customize.webp" alt="moon"
                            class="img-fluid   justify-content-center rounded-5 animate__animated animate__slideInLeft animate__slower 2s"
                            title="moon" />
                    </div>
                </div>
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/track-products.webp" alt="moon"
                            class="img-fluid   justify-content-center rounded-5 animate__animated animate__slideInRight animate__slower 2s"
                            title="moon" />
                    </div>
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                تتبع منتجاتك بطرق متعددة
                            </h2>
                            <p class="text-black-50 fs-5 lh-base fw-bold mt-4 text-center text-md-start">
                                يتيح لك النظام إمكانية تتبع منتجاتك بدقة إما عن طريقة الرقم التسلسلي أو رقم الشحنة أو
                                تاريخ الانتهاء وتعيين حد معين ينبهك عنده النظام بوصول الكمية إليه أو انخفاضها عنه. كما
                                يمكنك عرض قائمة بالعناصر المتوفرة، وتتبع المباع منها أو المتبقي في المخزون بسهولة.
                            </p>
                        </div>
                        <div class="circles2">
                            <img src="../assets/images/circles-r.webp" alt="circles" class="img-fluid">
            ...
            <section class="container mt-5">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                احصل على إشعارات عند وصول كمية <br> منتجاتك إلى حد معين
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                بفضل خصائص الأتمتة في نظام Z4U، يمكنك تحديد حد أدنى لكمية المنتج في مخزونك بحيث يرسل
                                لك النظام إشعارًا في حال وصول الكمية إلى هذا الحد أو الانخفاض عنها من أجل اتخاذ الإجراء
                                المناسب لتوفير منتجك تلبية لحاجة عملائك.
                            </p>
                        </div>
                        <div class="circles">
                            <img src="../assets/images/circles.png" alt="circles" class="img-fluid">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/low-stock.webp" alt="moon"
                            class="img-fluid   justify-content-center rounded-5 animate__animated animate__slideInLeft animate__slower 2s"
                            title="moon" />
                    </div>
                </div>
        ...
        <div class="bg-settings mtt mb-5">
            <section class="container">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                ضمِّن منتجاتك في قوائم الأسعار
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                أنشئ قوائم الأسعار المختلفة وخصصها حسب احتياجاتك وضمِّن المنتجات المطلوبة بها بسولة، مع
                                إمكانية إضافة المنتج نفسه بسعر مختلف في قائمة الأسعار من خلال تحديدها في ملف المنتج
                                التعريفي، حيث يمكنك تحديد قائمة الأسعار المطلوبة أثناء إصدار الفاتورة بسهولة لإدخال
                                المنتجات بأسعارها الموجودة داخل هذه القائمة.
                            </p>
                        </div>
                        <div class="circles">
                            <img src="../assets/images/circles.png" alt="circles" class="img-fluid">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/price-list.webp" alt="moon"
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/barcode.webp" alt="moon"
                            class="img-fluid   justify-content-center rounded-5 animate__animated animate__slideInRight animate__slower 2s"
                            title="moon" />
                    </div>
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                ابحث عن المنتجات باستخدام الباركود
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                أدخل الباركود للمنتج عند إضافته إلى حسابك أو قم بإنشائه عشوائيًا، بحيث يمكنك استخدامه
                                للبحث عن منتجاتك والعثور عليها بسهولة لاستخدامها إما في الفلترة أو عند تضمينها في فواتير
                                البيع أو الشراء.
                            </p>
                        </div>
                        <div class="circles2">
            ...
            <section class="container">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                أصدر تقارير مفصلة عن منتجاتك
                            </h2>
                            <p class="text-black-50 fs-5 lh-base fw-bold mt-4 text-center text-md-start">
                                تتبع مدى توفر منتجاتك ومستوياتها في مستودعك من خلال تقارير مفصلة بما في ذلك الجرد
                                ومبيعات المنتجات وملخص عمليات المخزون والحركة التفصيلية للمخزون وملخص رصيد المخازن، إلى
                                جانب تقارير تتبع المنتجات إما حسب الرقم المسلسل أو رقم الشحنة أو تاريخ الانتهاء،
                                بالإضافة إلى تقارير المنتجات المجمعة بما في ذلك تقارير دليل المنتجات المجمعة أو الأرصدة
                                المتاحة للمنتجات المجمعة.
                            </p>
                        </div>
                        <div class="circles">
                            <img src="../assets/images/circles.png" alt="circles" class="img-fluid">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/stock-detailed.webp" alt="moon"
                            class="img-fluid  justify-content-center rounded-5 animate__animated animate__slideInLeft animate__slower 2s"
                            title="moon" />
                    </div>
                </div>
