            ...
            <div class="row pb-0 mt-5 gap-lg-3">
                <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                    ...
                    <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                        ...
                        Z4U برنامج مبيعات متكامل، ييسر عملية البيع نفسها وما يرتبط منها من تسهيلات كالأقساط وقوائم
                        الأسعار المتعددة وخصومات شركات التأمين، وكذلك ما يتعلق بموظفي المبيعات ومسئولياتهم عن العملاء
                        وتقييم الأداء لصرف العمولات، كما يتيح Z4U بعض المميزات التسويقية كالخصومات والعروض ونقاط
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            ...
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                ...
                                Z4U سواء داخل مقر عملك أو عبر الإنترنت بفضل الخدمات السحابية في النظام، قم بتوصيل
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            ...
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                ...
                                نقاط البيع الجديد من Z4U الذي يمكنك تثبيته على جهازك واستخدامه دون حاجة للاتصال
                ...
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            ...
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                نظِّم اتفاقيات التقسيط مع عملائك بسلاسة عبر خصائص الأتمتة التي يوفرها Z4U. فعند إنشاء
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            ...
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                ...
                                في نظام Z4U التي تتيح لك تحقيق الأهداف المرجوة من أعمالك عبر إدارة سلسة واحترافية
                ...
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            ...
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-3 text-center text-md-start">
                                أدِر تأمينات العملاء لديك وعرِّف شركات التأمين باحترافية مع نظام Z4U. باستخدام الأدوات
                                ...
                                بدقة. وحدد المنتجات والخدمات التي تخضع كل منها لنسب التأمين المتفق عليها، وسيعمل Z4U
                ...
                <div class="row pb-0 mt-5 gap-lg-4 position-relative">
                    <div class="col-lg-5 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            ...
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                يوفر لك نظام Z4U مجموعة من القوالب الجاهزة للطباعة أو الاستخدام بما في ذلك قوالب
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            ...
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-3 text-center text-md-start">
                                ...
                                يوفرها لك Z4U، حيث يتيح لك إمكانية إضافة حقول مخصصة سواء في الفاتورة أو عرض الأسعار أو
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            ...
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-3 text-center text-md-start">
                                ...
                                Z4U لمساعدتك في اتخاذ قرارات تساهم في زيادة أرباحك وإدارة عملية البيع لديك باحترافية،
