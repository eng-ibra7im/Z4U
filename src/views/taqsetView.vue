            ...
            <div class="row pb-0 mt-5 gap-lg-3">
                <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                    ...
                    <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                        يتيح لك برنامج إدارة وحساب الأقساط من نظام Z4U إمكانية تقسيم إجمالي الفاتورة المستحقة على
                    ...
                    <ul
                        ...
                        <li class="my-1">
                            نظام تقسيط Z4U يُصدِّر تنبيهات آلية للعميل عند كل قسط.
                        </li>
                        <li class="my-1">
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            ...
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                ...
                                المستحق على الفاتورة. فيما يقوم نظام Z4U بإثبات كافة الأقساط بوصفها مبالغ مالية مستحقة
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            ...
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                ...
                                ومتابعة الأقساط الشهرية من Z4U؛ حدد عدد الأقساط على الفاتورة والمدة الفاصلة بين كل قسط
                ...
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            ...
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                يتيح لك رنامج أقساط Z4U العديد من خيارات مدفوعات العملاء ليتسنى لك تسجيل عمليات سداد
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 m mtt mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            ...
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                ...
                                حيث يوفر لك Z4U نظام إشعارات نشط للإبلاغ عن أي أقساط متأخرة السداد، بالإضافة إلى إجراء
