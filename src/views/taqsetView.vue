    ...
    <main class="overflow-hidden">
            ...
            <div class="row pb-0 mt-5 gap-lg-3">
                <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                    <h1 class="text-black fw-bolder lh-base display-5 mb-2 text-center text-md-start">
                        برنامج تسجيل ومتابعة الاقساط
                    </h1>
                    <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                        يتيح لك برنامج إدارة وحساب الأقساط من نظام دفترة إمكانية تقسيم إجمالي الفاتورة المستحقة على
                        العميل إلى مجموعة أٌقساط يتم دفعها على فترات زمنية مختلفة سواء شهرية او سنوية؛ حدد قيمة القسط
                        ومعدل السداد حسب الاتفاق، واترك آلية النظام تحسب عدد الأقساط الواقعة على العميل وتاريخ استحقاق
                        كل منها. تمتع بتجربة مرنة وأكثر سلاسة عند تعديل قيم الأقساط المسجلة سواء قيمة القسط أو تاريخ
                        استحقاقها، وكن على اطلاع دائم بالأقساط متأخرة السداد من خلال إشعارات التنبيه داخل النظام.
                    </p>
                    <ul
                        ...
                        <li class="my-1">
                            يمكنك استخدام برنامج حساب الأقساط الشهرية مجانًا لمدة 14 يوم.
                        </li>
                        <li class="my-1">
                            يسهل من خلال البرنامج تفعيل اتفاقيات التقسيط على فواتير العملاء ما دامت غير مدفوعة كليًا.
                        </li>
                        <li class="my-1">
                            نظام تقسيط دفترة يُصدِّر تنبيهات آلية للعميل عند كل قسط.
                        </li>
                        <li class="my-1">
                            يظهر لك إشعارات بالأقساط متأخرة الدفع لتنبيهك بالتواصل مع هؤلاء العملاء.
                        </li>
                        <li class="my-1">
                            سهولة سداد وتسجيل مدفوعات العملاء عن الأقساط بشكل منظم.
                        </li>
                        <li class="my-1">
                            يمكن استخدام منصات خارجية للتقسيط بدلًا من تحمل تكلفة التقسيط بنفسك مثل منصة تمارا.
                        </li>
                    </ul>
                </div>
        ...
        <div class="bg-settings">
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                فعِّل اتفاقية التقسيط على فاتورة العميل
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                بخطوات بسيطة عبر واجهة سهلة الاستخدام؛ فعِّل اتفاقية التقسيط على أي من الفواتير غير
                                المدفوعة أو المدفوعة جزئيًا في حسابك، واستعرض خيارات التقسيط المتاحة عن إجمالي المبلغ
                                المستحق على الفاتورة. فيما يقوم نظام دفترة بإثبات كافة الأقساط بوصفها مبالغ مالية مستحقة
                                على العميل ويربطها مباشرة بالفاتورة؛ واحصل على بيان لمخلص حالة السداد والمبالغ المدفوعة
                                والمتبقي منها.
                            </p>
                        </div>
                        <div
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/agreement-sc.png" alt="moon"
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                حدد تفاصيل الأقساط حسب الحاجة
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                اضبط قواعد التقسيط الخاصة بالعميل بسهولة مع خصائص الأتمتة المتقدمة في برنامج تسجيل
                                ومتابعة الأقساط الشهرية من دفترة؛ حدد عدد الأقساط على الفاتورة والمدة الفاصلة بين كل قسط
                                وآخر، وسيتولى النظام ضبط قيمة الأقساط وتحديد تواريخ استحقاقها، وذلك وفقًا لتاريخ أول
                                قسط.
                            </p>
                        </div>
                        <div class="circles2">
        ...
        <div class="bg-settings mtt mb-5">
            <section class="container">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                سجِّل مدفوعات عملائك عن الأقساط المستحقة بسلاسة
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                يتيح لك رنامج أقساط دفترة العديد من خيارات مدفوعات العملاء ليتسنى لك تسجيل عمليات سداد
                                العملاء عن الأقساط المستحقة بدقة؛ حيث يمكنك عرض القائمة المختصرة للأقساط وسداد المستحق
                                منها، أو التوجه إلى ملف العميل مباشرة وتسجيل رصيد المدفوعات الذي سيعمل تلقائيًا على سداد
                                قيمة الأقساط المطلوبة.
                            </p>
                        </div>
                        <div class="circles">
                            <img src="../assets/images/circles.png" alt="circles" class="img-fluid">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/summary-sc.png" alt="moon"
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/overdue-sc.png" alt="moon"
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mtt mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                احصل على تجربة مرنة ودقيقة <br> لمعالجة الأقساط
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                نفِّذ عمليات التعديل على الأقساط المسجلة لديك بسلاسة، بما في ذلك قيمة الأقساط وتواريخ
                                استحقاقها، من دون الالتزام بالتقسيم الآلي الخاص بالنظام، وسيعمل النظام على إعادة حساب
                                الأقساط المتبقية تلقائيًا بناءً على التعديلات الجديد التي أجريتها بفضل خصائص الأتمتة
                                التي يتميز بها دفترة.
                            </p>
                        </div>
                        <div class="circles2">
                            <img src="../assets/images/circles-r.webp" alt="circles" class="img-fluid">
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 m mtt mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                استقبل الإشعارات عن الأقساط متأخرة السداد
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                احصل على إشعارات تنبيه بخصوص الأقساط التي حان موعد سدادها أو التي تأخر العميل في سدادها،
                                حيث يوفر لك دفترة نظام إشعارات نشط للإبلاغ عن أي أقساط متأخرة السداد، بالإضافة إلى إجراء
                                تغيير تلقائي لحالة القسط بمجرد تجاوز العميل تاريخ استحقاق القسط دون سداده.
                            </p>
                        </div>
                        <div class="circles">
                            <img src="../assets/images/circles.png" alt="circles" class="img-fluid">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/reminder-sc.png" alt="professional"
