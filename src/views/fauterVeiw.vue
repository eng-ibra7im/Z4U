    ...
    <main class="overflow-hidden">
            ...
            <div class="row pb-0 mt-5 gap-lg-3">
                <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                    <h1 class="text-black fw-bolder lh-base display-5 mb-2 text-center text-md-start">
                        برنامج فواتير عربي للشركات والمحلات
                    </h1>
                    <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                        برنامج فواتير بسيط ومجاني لمدة أسبوعين كفترة تجريبية، ويعينك برنامج فواتير دفترة على إصدار
                        ...
                        دفترة لأكثر من 50 مجال عمل مع أدوات تخصيص مرنة تجعل النظام يعمل تمامًا كما تريد.
                    </p>
                    <ul
                        ...
                        <li class="my-1">
                            يمكنك استخدام برنامج الفواتير العربي من دفترة بشكل مجاني لمدة 14 يوم.
                        </li>
                        <li class="my-1">
                            فواتير بسيطة وضريبية شاملة جميع البيانات.
                        </li>
                        <li class="my-1">
                            قوالب جاهزة وأدوات لتخصيص الفواتير.
                        </li>
                        <li class="my-1">
                            إتاحة بعض الخصائص كتفعيل التقسيط والتحصيل الآجل للفواتير وإصدار مرتجع.
                        </li>
                        <li class="my-1">
                            مساعدتك في توفير مزايا تسويقية كالخصومات ونقاط الولاء وعروض الأسعار.
                        </li>
                        <li class="my-1">
                            وسائل دفع متنوعة.
                        </li>
                        <li class="my-1">
                            توافر نسخة من برنامج الفواتير للايفون والاندرويد بنفس مميزات برنامج سطح المكتب.
                        </li>
                        <li class="my-1">
                            التقارير المتعلقة بالفاتورة.
                        </li>
                    </ul>
                </div>
        ...
        <div class="bg-settings">
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                أضف بيانات فاتورتك في ثوانٍ عبر بضع نقرات <br> بسيطة
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                ربما أردت أن تصدر فواتير العملاء لمستهلك نهائي من النوع B2C أو لشركة أو منظمة من النوع
                                B2B وهو ما يفرض طبيعة مختلفة لبيانات الفاتورة بحسب نوع العملاء، لذلك يقدم لك دفترة
                                برنامج للفواتير عربي يصدر الفواتير البسيطة والضريبية مع إتاحة حقول للبيانات تناسب طبيعة
                                الطرف المُصدَّرة إليه الفاتورة. يمكنك دائمًا إرفاق المزيد من البيانات كضريبة القيمة
                                المضافة أو أي نوع ضريبي آخر، وبيانات الشحن إن كنت مسئولًا عن تحصيله، وكذلك لك إرفاق ملف
                                الفاتورة أو أي مرفقات متعلقة.
                            </p>
                        </div>
                        <div
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/easy-invoice.webp" alt="moon"
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/good-looking.webp" alt="moon"
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                استخدم القوالب الجاهزة وأدوات سهلة <br> لتخصيص الفواتير
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                الفاتورة مستند قانوني وتجاري ويعبر كذلك عن علامتك التجارية، لذلك يوفر لك برنامج فواتير
                                دفترة قوالب عديدة بشكل مجاني، اختر الشكل الملائم وتحكم في إظهار شعار الشركة وكافة بيانات
                                التواصل ذات الصلة بأعمالك، واظهر بالتصميم الذي يعكس قيمك وشخصيتك التجارية. كما يتاح لك
                                اللجوء لأدوات تخصيص الفواتير لكي تضيف أو تحذف بعض الحقول أو تتحكم بطريقة العرض بحسب
                                المناسب لك، ويمكنك اعتماد القالب الذي تريد كقالب أساسي تلقائي أو التبديل بين عدة
                                اختيارات للقوالب الملائمة لك.
                            </p>
                        </div>
                        <div class="circles2">
        ...
        <div class="bg-settings mtt mb-5">
            <section class="container">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                فعّل خصائص أكثر لتصميم فواتير مثالية
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                يتيح لك برنامج فواتير مبيعات دفترة إمكانية تعيين فواتير دورية بما يناسب احتياجات أعمالك،
                                وذلك من خلال تعيين تاريخ استحقاق الفاتورة الأولى وعدد التكرارات في فترة معينة، وسيقوم
                                النظام بإنشاء الفواتير تلقائيًا حسب الفترة المحددة وإرسالها إلى العميل مع تذكيرات
                                بمواعيد الاستحقاق. كما يمكنك تفعيل الأقساط على الفواتير وتذكير العميل بشكل آلي بميعاد
                                تسديد القسط، بالإضافة لإمكانية تحصيل المستحقات المالية فوريًا أو اعتبار الفاتورة آجلة مع
                                تحديد أقصى موعد للاستحقاق. حتى بعد إدخال فواتير للعميل وإصدارها يمكنك إصدار مرتجع لمحو
                                أثر العملية وضبط الجوانب المحاسبية، هذا وأكثر من الخصائص يتوفر من خلال برنامج فواتير
                                مجاني لمدة 14 يوم تتاح لك فيها جميع الإمكانيات.
                            </p>
                        </div>
                        <div class="circles">
                            <img src="../assets/images/circles.png" alt="circles" class="img-fluid">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/ready-made.webp" alt="moon"
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/create-sales.png" alt="moon"
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                استفد بالمزايا التسويقية من خلال تطبيق <br> فواتير Z4U
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                إن أردت إضافة خصومات استثنائية لبعض العملاء على الفواتير، أو أردت توفير عروض أسعار تخص
                                مناسبة سنوية، أو حتى تفعيل برنامج كامل لنقاط الولاء وربطه بالفواتير لكي يستخدم العميل
                                النقاط خاصته وقتما شاء، برنامج فواتير دفترة يوفر لك مزايا عديد يمكنك استخدامها لربط
                                العملاء بعلامتك التجارية ولرفع العائد من مجهوداتك التسويقية.
                            </p>
                        </div>
                        <div class="circles2">
                            <img src="../assets/images/circles-r.webp" alt="circles" class="img-fluid">
        ...
        <div class="bg-settings mtt">
            <section class="container mt-5">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 m mtt mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                حصّل مدفوعاتك دون أدنى جهد
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                وفِّر لعملائك خيارات دفع متنوعة تناسب كل منهم وقم بتحصيل أموالك عبر بوابات دفع متعددة
                                عبر الإنترنت مدعومة من النظام، بما في ذلك بطاقات الائتمان وغيرها من وسائل الدفع
                                الإلكتروني، مما يوفر سهولة في المعاملات مع عملائك وكذلك تحصيل أموال أكثر سلاسة على نحو
                                مضمون.
                            </p>
                        </div>
                        <div class="circles">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/professional.webp" alt="professional"
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/automated.webp" alt="automated"
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-3 text-center text-md-start">
                                تابع أعمالك من خلال برنامج الفواتير للايفون <br> والاندرويد من Z4U
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-3 text-center text-md-start">
                                يوفر دفترة نسخة للايفون وأخرى للاندرويد بحيث تستطيع مباشرة عملك في أي وقت ومن أي مكان،
                                برنامج فواتير دفترة بسيطة وملائم لأجهزة المحمول الذكية، ويوفر كامل الإمكانيات المتاحة من
                                جهاز سطح المكتبة؛ بنفس السرعة والدقة في العمل، وباقة من برامج أخرى مدمجة ببرنامج
                                الفواتير كبرنامج المحاسبة ونقاط البيع والمخزون والمشتريات وإدارة الموارد البشرية، تعرف
                                على ما يدور لحظة بلحظة.
                            </p>
                            <div class="d-flex align-items-center justify-content-center justify-content-lg-start  gap-2 mt-4">
                                <img src="../assets/images/apple.webp" alt="apple.webp" width="150" class="img-fluid">
                                <img src="../assets/images/google-play.jpeg" alt="google-play.jpeg" width="150"
                                    class="img-fluid">
                            </div>
