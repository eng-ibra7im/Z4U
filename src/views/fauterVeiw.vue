            ...
            <div class="row pb-0 mt-5 gap-lg-3">
                <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                    ...
                    <ul
                        ...
                        <li class="my-1">
                            يمكنك استخدام برنامج الفواتير العربي من Z4U بشكل مجاني لمدة 14 يوم.
                        </li>
                        <li class="my-1">
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            ...
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                ...
                                B2B وهو ما يفرض طبيعة مختلفة لبيانات الفاتورة بحسب نوع العملاء، لذلك يقدم لك Z4U
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            ...
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                ...
                                Z4U قوالب عديدة بشكل مجاني، اختر الشكل الملائم وتحكم في إظهار شعار الشركة وكافة بيانات
                ...
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            ...
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                يتيح لك برنامج فواتير مبيعات Z4U إمكانية تعيين فواتير دورية بما يناسب احتياجات أعمالك،
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            ...
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                ...
                                النقاط خاصته وقتما شاء، برنامج فواتير Z4U يوفر لك مزايا عديد يمكنك استخدامها لربط
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            ...
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-3 text-center text-md-start">
                                يوفر Z4U نسخة للايفون وأخرى للاندرويد بحيث تستطيع مباشرة عملك في أي وقت ومن أي مكان،
                                برنامج فواتير Z4U بسيطة وملائم لأجهزة المحمول الذكية، ويوفر كامل الإمكانيات المتاحة من
                            ...
                            <div
                                class="d-flex align-items-center justify-content-center justify-content-lg-start  gap-2 mt-4">
                                <img src="../assets/images/apple.webp" alt="apple.webp" width="150" class="img-fluid">
                                <img src="../assets/images/google-play.jpeg" alt="google-play.jpeg" width="150"
                                    class="img-fluid">
                            </div>
