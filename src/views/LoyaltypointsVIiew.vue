            ...
            <div class="row pb-0  gap-lg-3">
                <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                    ...
                    <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                        ...
                        لك من دفترة، الإبقاء على عملائك. حيث تستطيع إنشاء قاعدة ولاء وتحديد مقدار النقاط التي يكتسبها
                    ...
                    <ul
                        ...
                        <li class="my-1">
                            يعتبر نظام ولاء دفترة نظام مرن تستطيع تشكيله لإرساء القواعد المناسبة لك.
                        </li>
                        <li class="my-1">
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            ...
                            <p class="text-black-50 fs-5 lh-base fw-bold mt-4 text-center text-md-start">
                                ...
                                التسويقية المتبعة لديك، لذلك يوفر لك دفترة برنامج نقاط ولاء عالي المرونة، ينفذ لك قاعدة
                ...
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            ...
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                يمكّنك دفترة من إنشاء قاعدة ولاء موسمية، على أن تجعل لها الأولوية في وقتها، مما يؤجل
