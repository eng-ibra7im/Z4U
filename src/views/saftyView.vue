            ...
            <div class="row pb-0 gap-lg-3">
                <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                    <h2 class="text-black fw-bolder lh-base  mb-2 text-center text-md-start">
                        برنامج إدارة تأمينات العملاء
                    </h2>
                    <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                        أدِر تأمينات العملاء وشركات التأمين باحترافية مع تطبيق التأمينات الذي يوفره لك نظام Z4U بواجهة
                        سهلة الاستخدام متضمنة أدوات وخصائص مؤتمتة مع دعم كامل للغة العربية، احفظ بيانات الشركات المتعاقد
                        معها وحدد شروطهم التأمينية ونسب الخصم للعملاء المنتفعين. احصل على المرونة اللازمة في تحديد نسب
                        التأمين وإمكانية تعريف العديد من الفئات والشرائح التأمينية لدى كل شركة. حدد المنتجات والخدمات
                        التي تخضع كل منها لنسب التأمين المتفق عليها، حيث سيعمل Z4U على تطبيق نسب التأمين والخصم آليًا
                        في الفواتير الصادرة للعملاء المنتفعين؛ إلى جانب إمكانية إصدار الفواتير المستحقة على شركات
                        التأمين بسلاسة على نحو دقيق.
                    </p>
                    <div
                        class="d-flex align-items-center mt-3 gap-2 justify-content-center justify-content-lg-start w-auto me-auto">
                        <a href="/"
                        ...
                        <a href="/"
                            class="btn btn-outline-primary text-blue rounded-1 pt-2 pb-2 fw-bold text-center text-lg-start animate__animated animate__slideInUp animate__slower 2s"
                            title="  مجانا" aria-label="  مجانا " rel="noopener noreferrer">
                            جوله سريعة
                        </a>
                    </div>
                ...
                <div class="col-lg-5 col-md-6">
                    <img src="../assets/images/برنامج-التأمينات.webp" alt="moon"
                        class="img-fluid w-100 mtt rounded-5 animate__animated animate__slideInDown animate__slower 2s"
        ...
        <div class="bg-settings">
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                عرِّف شركات التأمين المتعاقد معها <br> في حسابك
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                فعِّل خصائص التأمين الطبي للعملاء في حسابك وابدأ في إضافة قائمة شركات التأمين المتعاقد
                                معها في ملف تعريفي يتضمن كل البيانات اللازمة لإتمام المعاملات بسلاسة. تمتع بتجربة مميزة
                                مع الواجهة سهلة الاستخدام عند تحديد الفئات والشرائح التأمينية لكل شركة، مع إمكانية عرض
                                كافة الفواتير للمبالغ المطلوب تحصيلها عن الفترات المحددة.
                            </p>
                        </div>
                        <div
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/client-invoice-sc.png" alt="moon"
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                حدد الفئات والشرائح التأمينية لكل <br> شركة على حدة
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                في خطوات بسيطة؛ عرِّف مختلف الفئات التأمينية لكل شركة تأمين لديك، وحدد مجموعات المنتجات
                                والخدمات الخاضعة للتأمين في كل فئة، ثم ابدأ في تعيين هذه الفئات للعملاء المنتفعين من
                                نظام التأمين في حسابك، وسيقوم برنامج Z4U بتطبيق نسب التأمين والخصم على العملاء داخل
                                الفواتير تلقائيًا، إلى جانب تحديد قيمة السداد التشاركي الخاص بشركة التأمين وحساب صافي
                                المستحق سداده من العميل، وذلك بفضل خصائص الأتمتة المتقدمة من نظام Z4U.
                            </p>
                        </div>
                        <div class="circles2">
        ...
        <section class="container">
            <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                    <div>
                        <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                            حدد نسب التأمين والخصم على فئات <br> المنتجات والخدمات بالحساب
                        </h2>
                        <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                            يتيح لك تطبيق إدارة التأمينات في Z4U إمكانية تحديد نسبة الغطاء التأميني للشركة ونسبة الخصم
                            للعميل إن وجد، وذلك على فئة أو أكثر من فئات المنتجات والخدمات الخاضعة للتأمين، إلى جانب
                            إمكانية تحديد الحد الأقصى لمبلغ التأمين الذي تتحمله الشركة عن كل فاتورة يتم إصدارها لأحد
                            العملاء على الحساب.
                        </p>
                    </div>
                    <div class="circles">
                ...
                <div class="col-lg-5 col-md-6">
                    <img src="../assets/images/classes-sc.png" alt="moon"
                        class="img-fluid mt-4 w-100 justify-content-center rounded-5 animate__animated animate__slideInLeft animate__slower 2s"
                        title="moon" />
                </div>
            </div>
        </section>
