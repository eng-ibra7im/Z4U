    ...
    <main class="overflow-hidden">
            ...
            <div class="row pb-0 gap-lg-3">
                <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                    ...
                    <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                        نظم مورديك باحترافية مع الأدوات المتقدمة التي يوفرها برنامج Z4U في واجهة سهلة الاستخدام تدعم
                        اللغة العربية، حيث يمكنك إنشاء ملف خاص لكل مورد يتضمن كافة بياناته بما في ذلك معلومات التواصل
                        ومعلومات شركته، مما يسهل عملية إصدار فواتير الشراء وإرسالها إلى مورديك متضمنة البيانات اللازمة
                        في تصميم احترافي، بالإضافة إلى إدارة فعالة لرصيد حساب المورد والمدفوعات ذات الصلة وتتبعها بدقة.
                    </p>
                    <div
        ...
        <div class="bg-settings">
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                أدِر تدفق أعمال الموردين وعمليات الشراء بكفاءة
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                أنشئ ملفًا لكل مورد لديك يتضمن بيانات التواصل معه وبيانات شركته وطرق الدفع المتفق عليها
                                وغيرها من البيانات المطلوبة لتسهيل المعاملات فيما بينكما، كما يتيح لك Z4U إضافة رصيد
                                افتتاحي في حساب المورد وإصدار كشف حساب مفصل له والحصول على رؤية أوضح حول المعاملات التي
                                تتم فيما بينكما، بالإضافة إلى تسهيل عمليات التواصل مع الموردين لإرسال فواتير الشراء
                                وإتمام المعاملات حسب حاجة العمل.
                            </p>
                        </div>
                        <div
                            class="d-flex align-items-center gap-2 justify-content-center justify-content-lg-start w-auto me-auto">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/manage-purchases.webp" alt="moon"
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                أصدر فواتير الشراء لكل مورد لديك
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                يوفر لك Z4U الأدوات اللازمة لإصدار فواتير الشراء وإرسالها إلى المورد سواء عبر البريد
                                الإلكتروني أو في حسابه على النظام، بالإضافة إلى تتبع دقيق للمدفوعات والكميات المستلمة
                                وتأكيدها وتسجيلها في حسابك وذلك لكل مورد على حدة.
                            </p>
                        </div>
                        <div class="circles2">
        ...
        <div class="bg-settings mtt mb-5">
            <section class="container">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mtt mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                تتبع المدفوعات من خلال كشف حساب مفصل
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                أصدر كشف حساب لكل مورد لديك على حدة، سواء كشف حساب ملخص أو مفصل حسب حاجة أعمالك لتتبع
                                حالة كل فواتير شراء تم إصدارها والمدفوعات ذات الصلة، بالإضافة إلى إمكانية مراجعة رصيد كل
                                مورد بدقة.
                            </p>
                        </div>
                        <div class="circles">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/track-payments.webp" alt="moon"
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/keep-informed.webp" alt="moon"
                            class="img-fluid   justify-content-center rounded-5 animate__animated animate__slideInRight animate__slower 2s"
                            title="moon" />
                    </div>
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                كن على اطلاع دائم بمجريات أعمالك مع التقارير المفصلة
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                أصدر تقارير مفصلة لتتبع مشترياتك من كل مورد، وكذا الرصيد وفواتير الشراء وحالات الدفع
                                وأنشطة الموظفين ذوي الصلة. راقب حالة مدفوعاتك واحصل على نظرة عامة عن فواتير الشراء
                                المدفوعة سواء جزئيًا أو بالكامل وغير المدفوعة، بالإضافة إلى عمليات الشراء سواء المستلمة
                                أو غير مستلمة لكل مورد على حدة.
                            </p>
                        </div>
                        <div class="circles2">
                            <img src="../assets/images/circles-r.webp" alt="circles" class="img-fluid">
