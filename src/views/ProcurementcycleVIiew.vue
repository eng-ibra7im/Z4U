    ...
    <main class="overflow-hidden">
            ...
            <div class="row pb-0 gap-lg-3">
                <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                    <h1 class="text-black fw-bolder lh-base display-5 text-center text-md-start">
                        برنامج دورة المشتريات
                    </h1>
                    <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                        تختص إدارة المشتريات على اختلاف حجمها من مؤسسة لمؤسسة بتوفير متطلبات الشركة بأفضل طريقة يمكنها
                        تحصيلها بها؛ من حيث الجودة، والسعر، والتوقيت، وغيرها من العوامل. لذلك يعينك برنامج دورة
                        المشتريات من Z4U على هيكلة الأمر بالطريقة التي تدعم احتياجاتك وتسهلها، إن أردت أن تسير العملية
                        بصورتها المثلى بإتباع كامل دورة المشتريات أو إن أردت أن تبدأ العملية لديك من أي نقطة، فمن السهل
                        تشكيل التطبيق ليناسب طريقة الإدارة لديك.
                    </p>
                    <div
        ...
        <div class="bg-settings">
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                استثمر في التكامل وأحفظ وقتك
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                أكثر الوقت يضيع في إرسال الطلبات الروتينية من كافة الأقسام لقسم المشتريات، أو من قسم
                                المشتريات للموردين، لذلك يوفر لك Z4U التكامل الأمثل بين عناصر دورة المشتريات المختلفة
                                بداية من تسجيل طلب الشراء ومتابعة حالة الطلب مع مسئولي المشتريات وحتى تسجيل فاتورة
                                الشراء واستلام الأصناف المطلوبة.
                            </p>
                        </div>
                        <div
                            class="d-flex align-items-center gap-2 justify-content-center justify-content-lg-start w-auto me-auto">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/save-time.webp" alt="moon"
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/access-all.webp" alt="moon"
                    ...
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                أرسل بطلب عروض الأسعار إلى كافة <br> مورديك بضغطة زر
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                بمجرد موافقتك على طلب شراء منتجك، أرسل طلبات عروض الأسعار لكافة الموردين المحددين بنقرة
                                واحدة، دون الحاجة لإجراء كل معاملة مع كل مورد على حدى؛ مرفقًا كمية المنتجات التي تريدها
                                والملاحظات المطلوب إبلاغها للمورد.
                            </p>
                        </div>
                        <div class="circles2">
        ...
        <div class="bg-settings mtt mb-5">
            <section class="container">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mtt mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                قارن بين عروض الأسعار .. وأحسم قرارك
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                يمكنك تسجيل كافة الموردين الذين تتعامل معهم على النظام كقاعدة بيانات جاهزة للاستخدام،
                                لتطلب منهم عروض الأسعار وقتما يأتيك طلب شراء من أي قسم من أقسام الشركة، لتقارن بسهولة
                                بين عروض الأسعار من حيث جودة منتجات كل مود مقابل السعر ووقت التوريد، وهو ما يجعل عملية
                                اتخاذ القرار باختيار المورد المناسب أيسر كثيرًا، وأدق.
                            </p>
                        </div>
                        <div class="circles">
                            <img src="../assets/images/circles.png" alt="circles" class="img-fluid">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/compare.webp" alt="moon"
                            class="img-fluid   justify-content-center rounded-5 animate__animated animate__slideInLeft animate__slower 2s"
                            title="moon" />
                    </div>
                </div>
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/purchase-order.webp" alt="moon"
                            class="img-fluid   justify-content-center rounded-5 animate__animated animate__slideInRight animate__slower 2s"
                            title="moon" />
                    </div>
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                أرسل أمر الشراء عبر البريد الإلكتروني
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                بعد اختيارك للمورد المناسب، أرسل له عبر البريد الإلكتروني أمر شراء الطلبية، مباشرة من
                                Z4U، دون الحاجة لأي تطبيقات خارجية، عن طريق تحويلك عرض الأسعار الذي أرسله المورد نفسه
                                إلى أمر شراء.
                            </p>
                        </div>
                        <div class="circles2">
            ...
            <section class="container mt-5">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                سجل فواتير الشراء .. وحصل الخصم الضريبي
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                فواتير المشتريات هي الوثيقة الداعمة لاستحقاقك الخصم الضريبي على ضريبة القيمة المضافة،
                                وعليك العناية بإصدارها بالصورة المطابقة للشروط. برنامج دورة المشتريات من Z4U يدعم
                                إصدار فواتير المشتريات، ومتابعة حالتها من حيث الدفع واستلام المنتجات، مع توافر طرق سداد
                                متنوعة.
                            </p>
                        </div>
                        <div class="circles">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/purchase-invoices.webp" alt="moon"
                            class="img-fluid   justify-content-center rounded-5 animate__animated animate__slideInLeft animate__slower 2s"
                            title="moon" />
                    </div>
                </div>
