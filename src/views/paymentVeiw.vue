<template>
    <main class="overflow-hidden">
        <div class="container">
            ...
            <div class="bg-color mtt-3 mb-5  rounded-4">
        ...
        <div class="bg-settings">
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                        <div>
                            <h2 class="text-black fw-bolder lh-base mb-4 text-center text-md-start">
                                صمم عروضك بناءً على فترة زمنية
                            </h2>
                            <p class="text-black-50 fs-4 lh-base fw-bold mt-4 text-center text-md-start">
                                وفر مختلف العروض لعملائك ليتم تطبيقها في فترة زمنية معينة، حدد تواريخ توافر العروض
                                والعروض الموسمية وسيتولى النظام تعيين تاريخي البدء والانتهاء تلقائيًا دون تدخل يدوي.
                            </p>
                        </div>
                        <div
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/automate-duration.webp" alt="moon"
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/discount.webp" alt="moon"
        ...
        <div class="bg-settings mtt mb-5">
            <section class="container">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/bulk-sale.webp" alt="moon"
            ...
            <section class="container mtt">
                <div class="row pb-0 mt-5 gap-lg-2 position-relative">
                    <div class="col-lg-5 col-md-6">
                        <img src="../assets/images/dynamic-offer.webp" alt="moon"
