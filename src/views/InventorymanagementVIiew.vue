            ...
            <div class="row pb-0 gap-lg-3">
                <div class="col-lg-6 col-md-6 mt-0 mt-lg-5 mb-5 mb-md-0 order-1 order-md-0">
                    ...
                    <ul
                        ...
                        <li class="my-1">
                            راقب كميات المخزون من خلال إشعارات تنبيه عند وصول كمية المنتج إلى حد معين أو قرب نفادها.
                        </li>
                        <li class="my-1">
                            أدِر كل مستودعاتك من مكان واحد.
                        </li>
                        <li class="my-1">
                            أصدر الأذون المخزنية المختلفة وحولها إلى فواتير مبيعات أو شراء بخطوات بسيطة.
                        </li>
                        <li class="my-1">
                            استخدم أدوات متقدمة للقيام بعمليات الجرد بدقة.
                        </li>
                        <li class="my-1">
                            حدد صلاحيات الموظفين المسؤولين عن إدارة المستودعات.
                        </li>
                        <li class="my-1">
                            استعرض التقارير المفصلة عن حركة المخزون والمستودعات وأداء فريق العمل المسؤول.
                        </li>
                    </ul>
                </div>
                <div class="col-lg-5 col-md-6">
                    <img src="../assets/images/page-banner66.webp" alt="moon"
